  ...
  return (
    <div className="h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw]">
      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md bg-black/90 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <button type="submit" className="animate-element animate-delay-600 w-full rounded-2xl bg-white text-black py-4 font-medium hover:bg-white/90 transition-colors">
                Sign In
              </button>
            </form>
            ...
            <div className="animate-element animate-delay-700 relative flex items-center justify-center">
              ...
              <span className="px-4 text-sm text-white/60 bg-black absolute">Or continue with</span>
            </div>
